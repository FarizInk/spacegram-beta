...
<div class="bg-white min-w-screen min-h-screen relative isolate">
  ...
  <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
    <div class="flex items-center justify-center mb-5">
      <img class="h-8 w-auto" src={svelteLogo} alt="Svelte Logo">
    </div>
    <div class="hidden sm:mb-8 sm:flex sm:justify-center">
      <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
        Announcing our next round of funding. <a href="#" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span>Read more</a>
      </div>
    </div>
